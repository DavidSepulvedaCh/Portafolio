...
export class ProjectService {
    ...
    constructor() {
        this.projects = [
            ...
            new Project('Luxua', 'Desarrollo en conjunto de un sistema CRM/ERP, con características de manejo de inventario, privilegios para distintos roles de usuarios, sistema de facturación.', 'https://github.com/DavidSepulvedaCh/Integrador_I', 'https://res.cloudinary.com/dwfh4s7tu/image/upload/v1688787907/luxuaA_cmuh3p.png', ['HTML5', 'CSS3-alt', 'php', 'MySQL']),
