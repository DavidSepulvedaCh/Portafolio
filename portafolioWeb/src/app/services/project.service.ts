...
export class ProjectService {
    ...
    constructor() {
        this.projects = [
            ...
            new Project('ChavezMeat', 'Software de escritorio para llevar el control de inventario y finanzas de una carniceria.', '', 'https://res.cloudinary.com/dwfh4s7tu/image/upload/v1688787796/lOGO_h1w7ex.png', ['Java']),
